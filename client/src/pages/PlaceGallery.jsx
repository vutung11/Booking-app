            ...
            <div className=" absolute inset-0 text-white bg-black  min-h-screen">
                <div className="bg-black p-8 grid gap-4">
                    ...
                    {place?.photos?.length > 0 && place.photos.map((photo, idx) => (
                        <img key={idx} src={'http://localhost:4000/uploads/' + photo} />
                    ))}
                </div>
            </div>
        )
        ...
        <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-2xl overflow-hidden">
            ...
            <div>
                ...
                <div className="overflow-hidden">
                    {place.photos?.[2] && (
                        <img onClick={() => setShowAllPhotos(true)} className="aspect-square object-cover relative top-2 overflow-hidden cursor-pointer" src={'http://localhost:4000/uploads/' + place.photos[2]} alt="" />
                    )}
                </div>
            </div>
        </div>
